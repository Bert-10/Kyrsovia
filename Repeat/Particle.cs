...
namespace Repeat
{
    public class Particle
    {
        ...
        public virtual void ChangeColor(Color pen)
        {}
        public virtual void ChangeColorToWhite()
        { }
        */
    }
    ...
    public class ParticleColorful : Particle
    {
        ...
        public override void ChangeColorToWhite()
        {
            FromColor =Color.White;
        }

        public override void ChangeColor(Color pen)
        {
            //base.Change(pen);
            FromColor = pen;
         //   ToColor = Color.White;
